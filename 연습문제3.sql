...
insert into `bank_account` values ('101-11-2001', 'S1', '자유저축예금', '220-80-52237', 23000000, '2003-04-14');
...
insert into `bank_account` values ('101-23-1007', 'L3', '주탁담보대출', '750210-1000002', 2700000, '2020-09-23');

insert into `bank_transaction` values(1, '101-11-1001', 1, 50000, '2022-08-21 4:26:52');
insert into `bank_transaction` values(2, '101-11-1003', 2, 120000, '2022-08-21 4:26:52');
insert into `bank_transaction` values(3, '101-11-1001', 2, 300000, '2022-08-21 4:26:52');
insert into `bank_transaction` values(4, '101-11-1002', 1, 1000000, '2022-08-21 4:26:52');
insert into `bank_transaction` values(5, '101-11-1001', 3, 0, '2022-08-21 4:26:52');
insert into `bank_transaction` values(6, '101-11-1005', 1, 200000, '2022-08-21 4:26:52');
insert into `bank_transaction` values(7, '101-11-1001', 1, 450000, '2022-08-21 4:26:52');
insert into `bank_transaction` values(8, '101-11-1002', 2, 32000, '2022-08-21 4:26:52');
insert into `bank_transaction` values(9, '101-11-1003', 3, 0, '2022-08-21 4:26:52');
insert into `bank_transaction` values(10, '101-11-1003', 1, 75000, '2022-08-21 4:26:52');
...
#실습 2-11
select *from `bank_customer` where `c_addr` like '경%';
#실습 2-12
...
count(case when `t_dist`=2 then `t_dist` end) as '입금 건수',
count(case when `t_dist`=3 then `t_dist` end) as '입금 건수'
from `bank_transaction`;
